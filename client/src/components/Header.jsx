...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.div className='text-stone-500 inline-flex items-center gap-2
        bg-white px-6 py-1 rounded-full border border-neutral-500'
        
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
        viewport={{ deley: 0.2, duration: 0.8 }}
        ...
        initial={{ opacity: 0}}
        animate={{ opacity: 1 }}
        transition={{deley: 0.4, duration: 2 }}
        ...
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{deley: 0.6, duration: 0.8 }}
    ...
    initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{default: { duration: 0.5 }, opacity: { deley:0.8, duration: 1 }}}
           ...
           className='flex flex-wrap justify-center gap-3 mt-16'>
             {Array(6).fill('').map((item, index)=>(
              ...
              alt='' key={index} width={70}/>
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{deley: 1.2, duration: 0.8 }}
